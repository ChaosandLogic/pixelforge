...
export const Screen: NodeTypeDef = {
  ...
  evaluate(inputs, params, ctx) {
    ...
    blendScreen(pixelsForBlend(a, ctx)!, pixelsForBlend(b, ctx)!, amount, out)
    return { pixels: out }
  }
}
